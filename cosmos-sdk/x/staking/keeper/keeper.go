...
import (
	...
	// belkycTypes"github.com/cosmos/cosmos-sdk/x/belkyc/types"
...
// func (k Keeper) StoreKyc(ctx sdk.Context, add string, trf bool) {
// 	fmt.Println("this is working------------")
...
// func (k Keeper) GetKyc(ctx sdk.Context, add string) []byte {
// 	store := prefix.NewStore(ctx.KVStore(k.storeKey), types.DelegationKey)
